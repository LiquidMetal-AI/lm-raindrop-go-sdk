...
type EndSessionNewParams struct {
	...
	SmartMemoryLocation EndSessionNewParamsSmartMemoryLocationUnion `json:"smartMemoryLocation,omitzero,required"`
...
type EndSessionNewParamsSmartMemoryLocationSmartMemory struct {
	...
	// **REQUIRED** FALSE
	SmartMemory EndSessionNewParamsSmartMemoryLocationSmartMemorySmartMemory `json:"smartMemory,omitzero,required"`
	paramObj
}
