...
func TestPutProcedureNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.PutProcedure.New(context.TODO(), raindrop.PutProcedureNewParams{
		...
		SmartMemoryLocation: raindrop.PutProcedureNewParamsSmartMemoryLocation{SmartMemory: shared.LiquidmetalV1alpha1SmartMemoryNameParam{ApplicationName: raindrop.String("demo"), Name: "memory-name", Version: raindrop.String("1234")}},
