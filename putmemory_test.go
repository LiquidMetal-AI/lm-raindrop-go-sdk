...
func TestPutMemoryNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.PutMemory.New(context.TODO(), raindrop.PutMemoryNewParams{
		...
		SmartMemoryLocation: raindrop.PutMemoryNewParamsSmartMemoryLocation{SmartMemory: shared.LiquidmetalV1alpha1SmartMemoryNameParam{Name: "memory-name", ApplicationName: raindrop.String("my-app"), Version: raindrop.String("1234")}},
