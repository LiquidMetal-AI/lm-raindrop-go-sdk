...
func TestQueryMemorySearchWithOptionalParams(t *testing.T) {
	...
	_, err := client.Query.Memory.Search(context.TODO(), raindrop.QueryMemorySearchParams{
		...
		SmartMemoryLocation: raindrop.QueryMemorySearchParamsSmartMemoryLocation{SmartMemory: shared.LiquidmetalV1alpha1SmartMemoryNameParam{Name: "memory-name", ApplicationName: raindrop.String("my-app"), Version: raindrop.String("1234")}},
