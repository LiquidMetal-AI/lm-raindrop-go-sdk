...
type StartSessionNewParams struct {
	...
	BodySmartMemoryLocation1 StartSessionNewParamsSmartMemoryLocationUnion `json:"smartMemoryLocation,omitzero,required"`
	...
	BodySmartMemoryLocation2 StartSessionNewParamsSmartMemoryLocationUnion `json:"smart_memory_location,omitzero"`
	paramObj
}
