...
func TestQueryProcedureSearchWithOptionalParams(t *testing.T) {
	...
	_, err := client.Query.Procedures.Search(context.TODO(), raindrop.QueryProcedureSearchParams{
		SmartMemoryLocation: raindrop.QueryProcedureSearchParamsSmartMemoryLocation{SmartMemory: shared.LiquidmetalV1alpha1SmartMemoryNameParam{ApplicationName: raindrop.String("demo"), Name: "memory-name", Version: raindrop.String("1234")}},
		Terms:               "system prompt",
