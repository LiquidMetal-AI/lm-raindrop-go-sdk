...
func TestGetMemoryGetWithOptionalParams(t *testing.T) {
	...
	_, err := client.GetMemory.Get(context.TODO(), raindrop.GetMemoryGetParams{
		...
		BodySmartMemoryLocation1: raindrop.GetMemoryGetParamsSmartMemoryLocationUnion{
			OfModuleID: &raindrop.GetMemoryGetParamsSmartMemoryLocationModuleID{
				ModuleID: "moduleId",
			},
		},
		...
		BodySmartMemoryLocation2: raindrop.GetMemoryGetParamsSmartMemoryLocationUnion{
			OfModuleID: &raindrop.GetMemoryGetParamsSmartMemoryLocationModuleID{
				ModuleID: "moduleId",
			},
		},
